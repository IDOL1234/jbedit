...
{
    public static String getName(CONSTANT_InvokeDynamic cnst, CONSTANTPoolElement pool[])
    {
    ...
    public static String getType(CONSTANT_InvokeDynamic cnst, CONSTANTPoolElement pool[])
    {
        CONSTANT_NameAndType nat = CONSTANT_POOL_DRIVER.getNameAndTypeValue(cnst.getName_and_type_index(), pool);
