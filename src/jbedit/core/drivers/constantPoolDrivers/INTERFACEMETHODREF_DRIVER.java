...
{
    public static String getClassName(CONSTANT_InterfaceMethodref cnst, CONSTANTPoolElement pool[])
    {
    ...
    public static String getName(CONSTANT_InterfaceMethodref cnst, CONSTANTPoolElement pool[])
    {
    ...
    public static String getClass(CONSTANT_InterfaceMethodref cnst, CONSTANTPoolElement pool[])
    {
        CONSTANT_NameAndType nat = CONSTANT_POOL_DRIVER.getNameAndTypeValue(cnst.getName_and_type_index(), pool);
