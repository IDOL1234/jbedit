...
public class Exceptions extends AbstractAttribute
{
    ...
    private LinkedList<Integer> exception_index_table; //(short)
    ...
    public LinkedList<Integer> getException_index_table()
    {
        return exception_index_table;
    }

    public void setException_index_table(LinkedList<Integer> exception_index_table)
    {
    ...
    public void selfLoad(DataInputStream mainInput, LinkedList<CONSTANTPoolElement> pool) throws IOException
    {
        ...
        exception_index_table = new LinkedList<Integer>();
        
        for (int i = 0; i < number_of_exceptions; i++)
        {
            exception_index_table.add(mainInput.readUnsignedShort());
        }
    }
    ...
    public void selfSave(DataOutputStream mainOutput) throws IOException
    {
        ...
        for (int i = 0; i < number_of_exceptions; i++)
        {
            mainOutput.writeShort(exception_index_table.get(i));
        }
    }
}
